...
import pytest
from plasmid_check.models import FrontierPayload, ExecutionStatus
from plasmid_check.engine import FrontierDomainEngine
from plasmid_check.agents import JunctionBoundaryVerifierAgent, ORFFullLengthCheckerAgent, AntibioticCassetteAuditorAgent, PlasmidCheckCoordinator
from plasmid_check.cli import main


def test_sub_agents():
    a1 = JunctionBoundaryVerifierAgent()
    ...
    a3 = AntibioticCassetteAuditorAgent()
...
def test_coordinator():
    ...
    assert "Synthetic Biology Plasmid Verification Standards" in ans or "specifications" in ans
