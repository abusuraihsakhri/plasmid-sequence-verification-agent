"""
Data Models & Telemetry Definitions for PlasmidCheck: NGS / Sanger Recombinant DNA Assembly Verification Agent.
...
class AgentTelemetryAlert:
    ...
    standard_reference: str = "Synthetic Biology Plasmid Verification Standards"
    timestamp: str = field(default_factory=lambda: datetime.datetime.now(datetime.timezone.utc).isoformat())
