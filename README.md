...
**Plasmid Sequence Verification Agent** is an advanced analytical and computational platform implementing Gibson / Golden Gate assembly junction boundary, ORF & cassette auditor.
...
docker run -p 8000:8000 plasmid-sequence-verification-agent
```
